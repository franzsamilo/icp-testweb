...
import { idlFactory } from './vanilla-icp.did.js';
export { idlFactory } from './vanilla-icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VANILLA_ICP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vanilla-icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vanilla-icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vanilla-icp.did.js")._SERVICE>}
 */
export const vanilla_icp = createActor(canisterId);
